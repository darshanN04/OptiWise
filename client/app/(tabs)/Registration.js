    ...
    if (validateInputs()) {
      try {
        const response = await axios.post(
          `http://192.168.31.145:${PORT}/v1/patients/register`,
          details
        );
        console.log(details);
        if (response.status === 200) {
          alert(
            `Patient Registered Successfully. Patient ID: ${response.data.patient_id}`
          );
        } else {
      ...
      <ScrollView contentContainerStyle={{ flexGrow: 1 }}>
        <View style={{ paddingTop: 200, zIndex: 4, paddingLeft: 20, gap: 30 }}>
          ...
          <View>
            ...
            {errors.father_name ? (
              <Text style={styles.errorText}>{errors.father_name}</Text>
            ) : null}
          </View>
            ...
            <View style={styles.inputContainer3}>
              <Picker
                ...
                onValueChange={(itemValue) =>
                  setDetails({ ...details, gender: itemValue })
                }
              >
          ...
          <View>
            ...
            {errors.aadhaar_no ? (
              <Text style={styles.errorText}>{errors.aadhaar_no}</Text>
            ) : null}
          </View>
          ...
          <View>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                onChangeText={(e) =>
                  setDetails({ ...details, emergency_name: e })
                }
              />
            </View>
            {errors.emergency_name ? (
              <Text style={styles.errorText}>{errors.emergency_name}</Text>
            ) : null}
          </View>
          ...
          <View>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                onChangeText={(e) =>
                  setDetails({ ...details, emergency_phone: e })
                }
              />
            </View>
          ...
          <View>
            ...
            <View style={styles.inputContainer}>
              <TextInput
                ...
                onChangeText={(e) =>
                  setDetails({ ...details, emergency_relation: e })
                }
              />
            </View>
          </View>
